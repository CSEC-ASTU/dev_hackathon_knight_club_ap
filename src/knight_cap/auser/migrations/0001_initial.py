# Generated by Django 3.2.12 on 2022-05-08 09:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sites.site', verbose_name='site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Division long name.', max_length=100, unique=True, verbose_name='Division name')),
                ...
                ('head_permissions', models.ManyToManyField(blank=True, related_name='head_permissions', to='auth.Permission')),
                ('members_permissions', models.ManyToManyField(blank=True, related_name='members_permissions', to='auth.Permission')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('division', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='position', to='auser.division')),
