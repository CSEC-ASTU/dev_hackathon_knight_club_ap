# Generated by Django 3.2.12 on 2022-05-08 00:10
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "short_name",
                    models.CharField(
                        help_text="Division short name.",
                        max_length=50,
                        verbose_name="Division short name",
                    ),
                ),
                (
                    "logo",
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, null=True, verbose_name="Division description"
                    ),
                ),
                (
                    "parent",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, null=True, verbose_name="Position description"
                    ),
                ),
                (
                    "division",
                    models.ForeignKey(
                        blank=True,
                        help_text="Division to which this position belongs/related.",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                ...
                (
                    "permissions",
                    models.ManyToManyField(
                        blank=True, related_name="positions", to="auth.Permission"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "short_name",
                    models.CharField(
                        help_text="Club short name.",
                        max_length=50,
                        verbose_name="Club short name",
                    ),
                ),
                (
                    "logo",
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, null=True, verbose_name="Club description"
                    ),
                ),
            ],
            options={
